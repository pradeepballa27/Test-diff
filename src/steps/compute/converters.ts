...
import {
  ...
  MAPPED_RELATIONSHIP_FIREWALL_RULE_TYPE, ENTITY_TYPE_COMPUTE_NETWORK_LOAD_BALANCER,
} from './constants';
import {GLOBAL_REGION, REGIONS_FIELD} from "../../constants";
...
export function createComputeSnapshotEntity(data: compute_v1.Schema$Snapshot, region: string) {
  return createGoogleCloudIntegrationEntity(data, {
    entityData: {
      source: data,
      assign: {
  ...
  return createGoogleCloudIntegrationEntity(data, {
    entityData: {
      ...
      assign: {
        ...
        public: false,
        internal: true,
        region: getElementFromField(data.region?? "", REGIONS_FIELD),
        webLink: getGoogleCloudConsoleWebLink(
  ...
  return createGoogleCloudIntegrationEntity(data, {
    entityData: {
      ...
      assign: {
        ...
        public: false,
        internal: true,
        region: GLOBAL_REGION, // gcp vpc networks are global https://cloud.google.com/vpc/docs/vpc
        CIDR: null,
        webLink: getGoogleCloudConsoleWebLink(
...
export function createRegionLoadBalancerEntity(data: compute_v1.Schema$UrlMap, region: string) {
  return createGoogleCloudIntegrationEntity(data, {
    entityData: {
      source: data,
      assign: {
...
export function createRegionNetworkLoadBalancerEntity(
    data: compute_v1.Schema$BackendService,
    region: string,
) {
  return createGoogleCloudIntegrationEntity(data, {
...
export function createNetworkLoadBalancerEntity(
    data: compute_v1.Schema$BackendService,
    region: string,
) {
  return createGoogleCloudIntegrationEntity(data, {
