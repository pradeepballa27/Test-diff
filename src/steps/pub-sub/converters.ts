...
import {GLOBAL_REGION} from "../../constants";
  ...
  return createIntegrationEntity({
    entityData: {
      ...
      assign: {
        ...
        region: GLOBAL_REGION, // pubsub is globally accessible, https://stackoverflow.com/questions/54995901/cloud-pub-sub-is-available-for-a-specific-region-what-does-this-mean-please-co
        webLink: getGoogleCloudConsoleWebLink(
