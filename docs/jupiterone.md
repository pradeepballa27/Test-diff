...
| [file](https://console.developers.google.com/apis/library/file.googleapis.com)                                 | file.googleapis.com                 |
...
| Cloud Storage File                                       | `google_storage_filestore_instance`                               | `DataStore`                        |
| Cloud VertexAI Model                                     | `google_vertexAI_model`                                           | `Model`                            |
...
| Compute Network LB Backend Service                       | `google_compute_lb_network`                                       | `Service`                          |
